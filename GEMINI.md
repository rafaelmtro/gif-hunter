...
- **Interface Features:**
    ...
    - **Multi-Tag Selection Box:** Dedicated section on the right displaying trending tags in a text-based grid. Supports multi-selection with orange-highlighted visual feedback; tags are automatically deselected when a new manual search is typed.
